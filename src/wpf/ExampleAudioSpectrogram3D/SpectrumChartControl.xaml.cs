...
namespace InteractiveExamples
{
    ...
    /// </summary>
    public partial class SpectrumChartControl : UserControl, IDisposable
    {
        private bool _clean;
        ...
        public Queue<string> QueueFiles { get => _queuefiles; set => _queuefiles = value; }
        ...
        private void OpenFile()
        {
            ...
            {
                //this.OpenFile(_queuefiles.Dequeue());
                var filepath = _queuefiles.Dequeue();
                _signalReader.OpenFile(filepath);
                _signalReader.Start();
                if (FileOpenEvent != null)
                {
                    FileOpenEvent(this, new SpectrumOpenFIleEventArgs(filepath));
                }
